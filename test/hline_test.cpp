...
int main()
{
    ...
    mmx::point< double> A(-5.25,-3.9375,-3.75), B(-5.25,-3.9375,-2.5);

    std::cout<<A<<" "<<B<<std::endl;
    std::cout<<"point-equidistant "<< equidist(L4,L3,A,B) <<std::endl;
    ...
    std:: cout << L4.distance2(q)<< std::endl;
     ...
     std::cout<<"distance au segment "<< L2.distance2(A, B)<<std::endl;

     std:: cout << L2.distance2(A)<< std::endl;
     std:: cout << L2.distance2(B)<< std::endl;
 std::cout<<"distance à la face "<< L2.distance2_to_face( A, B)<<std::endl;
    return 0;
