...
#define SELF tmsh_controler<2,CELL,VERTEX>
...
struct tmsh_controler<2,CELL,VERTEX> {
...
template<class CELL, class VERTEX>
int tmsh_controler<2,CELL,VERTEX>::split_direction(const CELL& cl) {
    return ((this->xsize(cl)<this->ysize(cl))?1:0);
}
